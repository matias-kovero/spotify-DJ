...
const THREE.BAS = window.THREE.BAS;
...
// https://codepen.io/flexmotion/pen/qZejVP
// https://codepen.io/last-first/pen/QNoWmO
export default function ImageContainer({ current, previous }) {

  return (
    <img src={current.album.images[0].url} className="vinyl" alt="" crossOrigin="anonymous" />
  )
}